...
You can download zip file and unzip Bannerslider extension before copy to the root folder of magento 2.
Open a terminal application and change to magento root directory and use command line :
